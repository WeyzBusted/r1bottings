...
manual_btn = InlineKeyboardButton(
    ...
    url="https://telegra.ph/R1-Investicii-02-12",
)
...
refer_btn = InlineKeyboardButton(
    ...
    url="https://telegra.ph/R7-dlya-partnerov-02-12",
)
...
info_btn = InlineKeyboardButton(
    emojize(":book: Информация"), url="https://telegra.ph/R1-Investicii-02-12"
)
licence_btc = InlineKeyboardButton(
    emojize(":lock: Соглашение"), url="https://telegra.ph/R7-soglashenie-02-12"
)
