...
new_text = emojize(
    "⁠<a href='https://telegra.ph/file/ee9b477aec080183e4598.png'>:black_small_square:</a>\
	Для начала работы с ботом, пройдите небольшую проверку,\
	просто вступите в <a href='https://t.me/+-v9GoBeOc5A1NDk1'>чат</a>\
	и <a href='https://t.me/+0SOOdKZlIb5mMDg1'>канал</a> ниже и нажмите кнопку продолжить.\
	\n\n:warning: Нажмите на <b>«Подписаться 1 и 2»</b>"
)

welcome_text = emojize("✈️Главное меню.")
...
def invest_text(cid):
    try:
        ...
        return emojize(
            f"<a href='https://telegra.ph/file/333a9e25ea7bb9f9eea30.png'>:black_small_square:</a>\
...
async def partners_text(cid):
    try:
        ...
        user = User.get(cid=cid)
        return emojize(
            f"<a href='https://telegra.ph/file/8fc119d74e930ac1cb860.png'>:black_small_square:</a>\
...
def balance_text(cid):
    try:
        ...
        refers = len(User.select().where(User.refer == cid))
        return emojize(
            f"<a href='https://telegra.ph/file/9c11478f7c23b3239c3b0.png'>:gear:</a>\
...
def calc_done(amount):
    return emojize(
        f"<a href='https://telegra.ph/file/9d2041acaa1d943dac090.png'>:black_small_square:</a>\
...
def settings_text():
    ...
    return emojize(
        f"<a href='https://telegra.ph/file/2f2ed957263507bb3d9d7.png'>:black_small_square:</a>\
		...
		\n\n:blue_heart: Дней работаем: <b>{delta.days}</b>\
...
manual_text = emojize(
    "<a href='https://telegra.ph/file/ec62f2e255c6b39c7e4dd.png'>:mortar_board:</a>\
...
out_done = lambda amount, req: emojize(
	...
	\n\n<i>Администрация проекта рассмотрит вашу заявку, деньги придут по мере нагрузки проекта! Есди выплата не придет в течении дня напишите в тех.поддержку @r1help</i>"
)

out_done_otz = emojize(
    "<b>Администация проекта одобрила вашу заявку на вывод</b>!\
	\n<i>Пожалуйста предоставьте скриншоты вывода в чат</i> :blue_heart:"
)
...
add_succesful = lambda amount: emojize(
    f"<a href='https://telegra.ph/file/9c11478f7c23b3239c3b0.png'>:blue_heart:</a>\
